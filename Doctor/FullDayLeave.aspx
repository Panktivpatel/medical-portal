<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorMaster.Master" AutoEventWireup="true" CodeBehind="FullDayLeave.aspx.cs" Inherits="Medical.Doctor.FullDayLeave" %>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="NewAppointments.aspx">New Appointments</a></li>
                            <li class="nav-item"><a class="nav-link" href="ReVisits.aspx">Regluar Visits</a></li>
                            <li class="nav-item"><a class="nav-link" href="OldAppointmnets.aspx">Old Appointments</a></li>
                        </ul>
                    </div>
                </li>
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                                    ...
                                    <div class="row">
                                        <div class="col-12 grid-margin">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title">Full Day Leave Form</h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <asp:TextBox ID="from" runat="server" CssClass="form-control time star" TextMode="Date"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <asp:TextBox ID="to" runat="server" CssClass="form-control time star" TextMode="Date"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
