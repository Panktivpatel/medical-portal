<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorMaster.Master" AutoEventWireup="true" CodeBehind="ReVisits.aspx.cs" Inherits="Medical.Doctor.ReVisits" %>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Today's Revisitors List</h4>
                                   <p class="card-subtitle card-subtitle-dash">You have 3 Patients Today</p>
                                  </div>
                                </div>
