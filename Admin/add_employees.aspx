<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminHomePage.Master" AutoEventWireup="true" CodeBehind="add_employees.aspx.cs" Inherits="Medical.Admin.add_employees" %>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div>
                            ...
                            <div class="m-t-20 text-center">
                                <asp:Button ID="add" runat="server" CssClass="btn btn-success submit-btn" Text="Add Employee" OnClick="add_Click" />
                            </div>
                        </div>
                    </div>
                </div>
