<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminHomePage.Master" AutoEventWireup="true" CodeBehind="add_assests.aspx.cs" Inherits="Medical.Admin.add_assests" %>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div>
                        ...
                        <div class="m-t-20 text-center">
                            <asp:Button ID="add" runat="server" CssClass="btn btn-primary submit-btn" Text="Add Asset" OnClick="add_Click"/>
                        </div>
                    </div>
                </div>
            </div>
